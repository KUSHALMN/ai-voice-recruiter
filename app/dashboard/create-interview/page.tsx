                      ...
                      {isParsingResume ? (
                        <div className="flex flex-col items-center gap-3 py-2 w-full max-w-xs">
                          ...
                          <div className="space-y-1.5 w-full text-center">
                            <span className="text-xs font-semibold text-blue-700 block animate-pulse">Analyzing Resume &amp; Generating Job Details...</span>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    >
                      <Sparkles className={`w-3.5 h-3.5 ${isGenerating ? 'animate-pulse text-blue-600' : ''}`} />
